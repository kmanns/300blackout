...
import{a as y,f as G,h as R}from"./network-error.js";import"@dropins/tools/recaptcha.js";import{events as U}from"@dropins/tools/event-bus.js";import{merge as C}from"@dropins/tools/lib.js";import{c as k,f as F,C as w,e as v,L as x}from"./getAdobeCommerceOptimizerData.js";import{CUSTOMER_INFORMATION_FRAGMENT as S}from"../fragments.js";import{p as D,E as H}from"./acdl.js";import{s as K}from"./setReCaptchaToken.js";const A=t=>{var g,e,o,s,a,c,m,u,T,d,E,M,r,N;const i=((m=t==null?void 0:t.data)==null?void 0:m.customer)??{},B=i.group_id!=null?btoa(String(i.group_id)):"",j={email:(e=i.email)!=null?e:"",firstName:(o=i.firstname)!=null?o:"",lastName:(a=i.lastname)!=null?a:"",groupUid:B};return C(j,(N=(r=(M=(E=(d=k)==null?void 0:d.getConfig())==null?void 0:E.models)==null?void 0:M.CustomerModel)==null?void 0:r.transformer)==null?void 0:N.call(r,t.data))},Q=`
  ...
  ${S}
`,n=async t=>{if(t){const i=((k==null?void 0:k.getConfig)==null?void 0:k.getConfig())??{},g=((i==null?void 0:i.authHeaderConfig)==null?void 0:i.authHeaderConfig.header)??"Authorization",e=((i==null?void 0:i.authHeaderConfig)==null?void 0:i.authHeaderConfig.tokenPrefix)??"Bearer";y(g,e?`${e} ${t}`:t)}return await G(Q,{method:"POST",cache:"no-cache"}).then(i=>A(i)).catch(R)},q=`
